...
fn insert_exceptions(exec_env: &mut ExecEnv){
    ...
    exec_env.insert_class(FatClass::new("java/lang/RuntimeException","java/lang/Exception"));
    exec_env.insert_class(FatClass::new("java/lang/IllegalStateException","java/lang/RuntimeException"));
}
...
pub(crate) fn insert_stdio(exec_env: &mut ExecEnv) {
    ...
    exec_env.insert_class(FatClass::new("java/nio/file/attribute/FileAttribute","java/lang/Object"));
    // TODO: Handle generics
    exec_env.insert_class(FatClass::new("java/util/AbstractCollection","java/lang/Object"));
    exec_env.insert_class(FatClass::new("java/util/AbstractList","java/util/AbstractCollection"));
    exec_env.insert_class(FatClass::new("java/util/ArrayList","java/util/AbstractList"));
    //todo!();
}
pub(crate) fn insert_core(exec_env: &mut ExecEnv){
    ...
    class_loader.add_virtual("getParent()Ljava/lang/ClassLoader;","java/lang/ClassLoader::getParent()Ljava/lang/ClassLoader;");
