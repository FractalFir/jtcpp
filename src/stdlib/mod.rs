...
pub(crate) fn insert_stdio(exec_env: &mut ExecEnv) {
    ...
    let mut filter_output_stream =
        FatClass::new("java/io/FilterOutputStream", "java/io/OutputStream");
    ...
    let mut abstract_collection = FatClass::new("java/util/AbstractCollection", "java/lang/Object");
    add_virtual!(
        abstract_collection,
    ...
    let mut abstract_list = FatClass::new("java/util/AbstractList", "java/util/AbstractCollection");
    add_virtual!(
        abstract_list,
    ...
    let mut array_list = FatClass::new("java/util/ArrayList", "java/util/AbstractList");
